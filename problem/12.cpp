...
// 	mang[7].C=9; mang[7].W=6;
// 	mang[8].C=11;mang[8].W=12;
// 	mang[9].C=25;mang[9].W=8;
// 	mang[10].C=4;mang[10].W=15;
// 	mang[11].C=31;mang[11].W=10;
// 	mang[12].C=40;mang[12].W=2;
 	cout<<Bag_Best(6,19,mang);
 	//cout<<Bag_Best(12,25,mang);
